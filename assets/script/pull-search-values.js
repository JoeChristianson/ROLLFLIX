// Takes selected input from sidebar and modifies the queue list

function pullVals() {
	var genreEls = document.querySelectorAll(
		"#genre-checkbox-list input:checked"
	);
	var ratingEls = document.querySelectorAll(
		"#rated-checkbox-list input:checked"
	);
